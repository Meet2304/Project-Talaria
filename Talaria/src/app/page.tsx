      ...
      <section className="container mx-auto px-4 py-32 text-center relative z-10">
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="space-y-4">
            <h1 className="font-bold tracking-tight bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent" style={{ fontSize: 'clamp(6rem, 15vw, 12rem)' }}>
              TALARIA
            </h1>
          </div>
        ...
        <section className="container mx-auto px-4 py-16 md:py-32 relative z-10">
          ...
          <FeatureCard>
            ...
            Heart Rate Monitoring
              ...
              <p className="mt-8 text-2xl font-semibold">Real-time cardiovascular tracking with MAX30102 sensor</p>
            </div>
          ...
          <FeatureCard>
            ...
            SpO2 Monitoring
              ...
              <p className="mt-8 text-2xl font-semibold">Continuous blood oxygen saturation tracking</p>
            </div>
          ...
          <FeatureCard>
            ...
            Gait Analysis
              ...
              <p className="mt-8 text-2xl font-semibold">Precise movement tracking with MPU6050 accelerometer</p>
            </div>
          ...
          <FeatureCard>
            ...
            Live Analytics
              ...
              <p className="mt-8 text-2xl font-semibold">Real-time data visualization and comprehensive insights</p>
            </div>
